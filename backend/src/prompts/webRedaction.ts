...
[[DEMANDES]]
La reprise des demandes au tribunal, une phrase par demande fournie ci-dessous (section "Demandes"), CHACUNE sur sa PROPRE ligne, separee des autres par une ligne vide (JAMAIS de tiret "-" ni de puce devant : des paragraphes de style judiciaire, pas une liste). Formule chaque demande avec le verbe en MAJUSCULES le plus approprie a son contenu (CONSTATER, DIRE ET JUGER, ORDONNER, CONDAMNER, PRONONCER, etc. selon ce qui convient), sans jamais en ajouter, en omettre ou en denaturer le sens. Si la condamnation aux depens est demandee, ajoute une derniere phrase "CONDAMNER [partie adverse] aux entiers depens de la procédure."
